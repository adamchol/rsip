...
impl Header {
    pub fn name(&self) -> &str {
        ...
        match self {
            Self::Accept(inner) => inner.name(),
            Self::AcceptEncoding(inner) => inner.name(),
            Self::AcceptLanguage(inner) => inner.name(),
            Self::AlertInfo(inner) => inner.name(),
            Self::Allow(inner) => inner.name(),
            Self::AuthenticationInfo(inner) => inner.name(),
            Self::Authorization(inner) => inner.name(),
            Self::CSeq(inner) => inner.name(),
            Self::CallId(inner) => inner.name(),
            Self::CallInfo(inner) => inner.name(),
            Self::Contact(inner) => inner.name(),
            Self::ContentDisposition(inner) => inner.name(),
            Self::ContentEncoding(inner) => inner.name(),
            Self::ContentLanguage(inner) => inner.name(),
            Self::ContentLength(inner) => inner.name(),
            Self::ContentType(inner) => inner.name(),
            Self::Date(inner) => inner.name(),
            Self::ErrorInfo(inner) => inner.name(),
            Self::Event(inner) => inner.name(),
            Self::Expires(inner) => inner.name(),
            Self::From(inner) => inner.name(),
            Self::InReplyTo(inner) => inner.name(),
            Self::MaxForwards(inner) => inner.name(),
            Self::MimeVersion(inner) => inner.name(),
            Self::MinExpires(inner) => inner.name(),
            Self::Organization(inner) => inner.name(),
            Self::Other(key, _) => key.as_str(),
            Self::Priority(inner) => inner.name(),
            Self::ProxyAuthenticate(inner) => inner.name(),
            Self::ProxyAuthorization(inner) => inner.name(),
            Self::ProxyRequire(inner) => inner.name(),
            Self::RecordRoute(inner) => inner.name(),
            Self::ReplyTo(inner) => inner.name(),
            Self::Require(inner) => inner.name(),
            Self::RetryAfter(inner) => inner.name(),
            Self::Route(inner) => inner.name(),
            Self::Server(inner) => inner.name(),
            Self::Subject(inner) => inner.name(),
            Self::SubscriptionState(inner) => inner.name(),
            Self::Supported(inner) => inner.name(),
            Self::Timestamp(inner) => inner.name(),
            Self::To(inner) => inner.name(),
            Self::Unsupported(inner) => inner.name(),
            Self::UserAgent(inner) => inner.name(),
            Self::Via(inner) => inner.name(),
            Self::Warning(inner) => inner.name(),
            Self::WwwAuthenticate(inner) => inner.name(),
        }
    }
    ...
    pub fn value(&self) -> &str {
        ...
        match self {
            Self::Accept(inner) => inner.value(),
            Self::AcceptEncoding(inner) => inner.value(),
            Self::AcceptLanguage(inner) => inner.value(),
            Self::AlertInfo(inner) => inner.value(),
            Self::Allow(inner) => inner.value(),
            Self::AuthenticationInfo(inner) => inner.value(),
            Self::Authorization(inner) => inner.value(),
            Self::CSeq(inner) => inner.value(),
            Self::CallId(inner) => inner.value(),
            Self::CallInfo(inner) => inner.value(),
            Self::Contact(inner) => inner.value(),
            Self::ContentDisposition(inner) => inner.value(),
            Self::ContentEncoding(inner) => inner.value(),
            Self::ContentLanguage(inner) => inner.value(),
            Self::ContentLength(inner) => inner.value(),
            Self::ContentType(inner) => inner.value(),
            Self::Date(inner) => inner.value(),
            Self::ErrorInfo(inner) => inner.value(),
            Self::Event(inner) => inner.value(),
            Self::Expires(inner) => inner.value(),
            Self::From(inner) => inner.value(),
            Self::InReplyTo(inner) => inner.value(),
            Self::MaxForwards(inner) => inner.value(),
            Self::MimeVersion(inner) => inner.value(),
            Self::MinExpires(inner) => inner.value(),
            Self::Organization(inner) => inner.value(),
            Self::Other(_, value) => value.as_str(),
            Self::Priority(inner) => inner.value(),
            Self::ProxyAuthenticate(inner) => inner.value(),
            Self::ProxyAuthorization(inner) => inner.value(),
            Self::ProxyRequire(inner) => inner.value(),
            Self::RecordRoute(inner) => inner.value(),
            Self::ReplyTo(inner) => inner.value(),
            Self::Require(inner) => inner.value(),
            Self::RetryAfter(inner) => inner.value(),
            Self::Route(inner) => inner.value(),
            Self::Server(inner) => inner.value(),
            Self::Subject(inner) => inner.value(),
            Self::SubscriptionState(inner) => inner.value(),
            Self::Supported(inner) => inner.value(),
            Self::Timestamp(inner) => inner.value(),
            Self::To(inner) => inner.value(),
            Self::Unsupported(inner) => inner.value(),
            Self::UserAgent(inner) => inner.value(),
            Self::Via(inner) => inner.value(),
            Self::Warning(inner) => inner.value(),
            Self::WwwAuthenticate(inner) => inner.value(),
        }
    }
}
